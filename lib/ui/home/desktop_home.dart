...
class DesktopHome extends StatefulWidget {
  @override
  State<DesktopHome> createState() => _DesktopLayoutState();
}

class _DesktopLayoutState extends State<DesktopHome> {
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 24), // Space between cards
                            Expanded(
                              child: _buildInfoCard(
                                context,
                                title: 'Our Values',
      ...
      builder: (context, constraints) {
        return Container(
          ...
          child: Column(
            ...
            children: [
              Icon(icon, color: Colors.white, size: constraints.maxHeight * 0.3), // Adjust icon size
              ...
              Flexible(
                child: Text(
                  ...
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: constraints.maxHeight * 0.06, // Responsive font size
                  ),
                  textAlign: TextAlign.center,
